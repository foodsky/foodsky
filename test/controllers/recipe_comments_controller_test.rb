...
class RecipeCommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recipe_comment" do
    assert_difference('RecipeComment.count') do
      post recipe_comments_url, params: { recipe_comment: { comment: @recipe_comment.comment, recipe_id: @recipe_comment.recipe_id, user_id: @recipe_comment.user_id } }
    end
  ...
  test "should update recipe_comment" do
    patch recipe_comment_url(@recipe_comment), params: { recipe_comment: { comment: @recipe_comment.comment, recipe_id: @recipe_comment.recipe_id, user_id: @recipe_comment.user_id } }
